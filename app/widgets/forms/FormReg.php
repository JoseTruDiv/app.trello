...
<?php function FormReg(){?>
    <div class="d-flex justify-center h-100 align-center">
        <div class="box-login">
            <form id="form-reg" class="d-flex flex-column g-1" action="setUser" method="post">
                <div class="d-flex align-center flex-column">
                    ...
                    <p class="text text-center" style="color: black;font-weight: bold;margin-top: 5px;">Regístrate para continuar</p>
                </div>
                <div class="d-flex justify-center flex-column g-1">
                    <input class="text input-login" type="email" name="emailLogin" id="emailLoginHidden" placeholder="email@gmail.com">
